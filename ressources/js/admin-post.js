jQuery( function( ) {
	...
	var rptApi = {
		...
		postTypeDivs : function() {
			jQuery('.posttypediv').each( function() {
				...
				jQuery( '#' + taxonomy + 'checklist li.popular-rpt :checkbox, #tabs-panel-posttype-' + taxonomy + '-most-recent :checkbox, #tabs-panel-posttype-' + taxonomy + '-search :checkbox' ).live( 'click', function( e ) {
